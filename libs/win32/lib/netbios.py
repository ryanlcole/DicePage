...
# 046862.python.netbios.line8.comment Constants generated by h2py from nb30.h
NCBNAMSZ = 16
MAX_LANA = 254
...
if __name__ == "__main__":
    # 046864.python.netbios.line267.comment code ported from "HOWTO: Get the MAC Address for an Ethernet Adapter"
    # 046865.python.netbios.line268.comment MS KB ID: Q118623
    ncb = NCB()
    ncb.Command = NCBENUM
    la_enum = LANA_ENUM()
    ncb.Buffer = la_enum
