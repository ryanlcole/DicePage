...
def ReadCallback(input_buffer, data, buflen):
    ...
    # 046002.python.OpenEncryptedFileRaw.line10.comment print(fnamein, fnameout, buflen)
...
def WriteCallback(output_buffer, data, buflen):
    ...
    # 046003.python.OpenEncryptedFileRaw.line18.comment # returning 0 as len terminates WriteEncryptedFileRaw
...
# 046004.python.OpenEncryptedFileRaw.line30.comment # create an encrypted file
fname = win32api.GetTempFileName(dst_dir, "ref")[0]
print("orig file:", fname)
f = open(fname, "w")
f.write("xxxxxxxxxxxxxxxx\n" * 32768)
f.close()
# 046005.python.OpenEncryptedFileRaw.line36.comment # add a couple of extra data streams
...
# 046006.python.OpenEncryptedFileRaw.line45.comment # backup raw data of encrypted file
...
try:
    ...
    # 046007.python.OpenEncryptedFileRaw.line53.comment # if context is not closed, file remains locked even if calling process is killed
    win32file.CloseEncryptedFileRaw(ctxt)
    f.close()

# 046008.python.OpenEncryptedFileRaw.line57.comment # restore data from backup to new encrypted file
