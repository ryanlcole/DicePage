...
if hasattr(ctypes, 'c_int64'):
    # 032180.python.xinerama.line18.comment Some builds of ctypes apparently do not have c_int64
    # 032181.python.xinerama.line19.comment defined; it's a pretty good bet that these builds do not
    # 032182.python.xinerama.line20.comment have 64-bit pointers.
...
class c_void(Structure):
    # 032183.python.xinerama.line27.comment c_void_p is a buggy return type, converting to int, so
    # 032184.python.xinerama.line28.comment POINTER(None) == c_void_p is actually written as
    # 032185.python.xinerama.line29.comment POINTER(c_void), so it can be treated as a real pointer.
...
# 032187.python.xinerama.line53.comment /usr/include/X11/extensions/Xinerama.h:44
...
# 032188.python.xinerama.line58.comment /usr/include/X11/extensions/Xinerama.h:50
...
# 032189.python.xinerama.line63.comment /usr/include/X11/extensions/Xinerama.h:56
XineramaIsActive = _lib.XineramaIsActive
XineramaIsActive.restype = c_int
XineramaIsActive.argtypes = [POINTER(Display)]

# 032190.python.xinerama.line68.comment /usr/include/X11/extensions/Xinerama.h:67
