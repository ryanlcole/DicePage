# 051980.python.shellcon.line1.comment Generated by h2py from \mssdk\include\shlobj.h and shellapi.h
WM_USER = 1024
DROPEFFECT_NONE = 0
DROPEFFECT_COPY = 1
DROPEFFECT_MOVE = 2
...
# 051981.python.shellcon.line14.comment # File operation flags used with shell.SHFileOperation
...
# 051982.python.shellcon.line33.comment # Extended file operation flags, used with IFileOperation
...
# 051983.python.shellcon.line116.comment Flags used with IContextMenu.QueryContextMenu
CMF_NORMAL = 0
CMF_DEFAULTONLY = 1
CMF_VERBSONLY = 2
CMF_EXPLORE = 4
...
# 051985.python.shellcon.line303.comment 60 unused
...
# 051986.python.shellcon.line424.comment ShellWindowFindWindowOptions
SWFO_NEEDDISPATCH = 1
SWFO_INCLUDEPENDING = 2
SWFO_COOKIEPASSED = 4

# 051987.python.shellcon.line429.comment ShellWindowTypeConstants
SWC_EXPLORER = 0
SWC_BROWSER = 1
SWC_3RDPARTY = 2
SWC_CALLBACK = 4
...
# 051988.python.shellcon.line436.comment SHARD enum for SHAddToRecentDocs
SHARD_PIDL = 1
SHARD_PATHA = 2
SHARD_PATHW = 3
SHARD_APPIDINFO = 4
...
SHARD_SHELLITEM = 8
# 051989.python.shellcon.line445.comment # SHARD_PATH = SHARD_PATHW
...
# 051990.python.shellcon.line543.comment Some manually added ones
...
BFO_QUERY_ALL = -1
# 052000.python.shellcon.line579.comment From ShlGuid.h
PID_FINDDATA = 0
PID_NETRESOURCE = 1
PID_DESCRIPTIONID = 2
PID_WHICHFOLDER = 3
...
PID_LINK_TARGET = 2
PID_QUERY_RANK = 2
# 052001.python.shellcon.line635.comment From PropIdl.h
...
PRSPEC_LPWSTR = 0
PRSPEC_PROPID = 1
# 052002.python.shellcon.line700.comment From ShObjIdl.h
...
# 052003.python.shellcon.line837.comment SHChangeNotifyRegister flags
...
# 052004.python.shellcon.line853.comment shlwapi stuff
...
# 052042.python.shellcon.line901.comment flags used with SHGetViewStatePropertyBag
SHGVSPB_PERUSER = 1
SHGVSPB_ALLUSERS = 2
SHGVSPB_PERFOLDER = 4
...
# 052043.python.shellcon.line914.comment IDeskband and related
DBIM_MINSIZE = 0x0001
DBIM_MAXSIZE = 0x0002
...
# 052044.python.shellcon.line933.comment Message types used with SHShellFolderView_Message
SFVM_REARRANGE = 1
SFVM_ADDOBJECT = 3
SFVM_REMOVEOBJECT = 6
SFVM_UPDATEOBJECT = 7
...
# 052045.python.shellcon.line943.comment SHELL_LINK_DATA_FLAGS enum, used with IShellLinkDatalist
SLDF_HAS_ID_LIST = 1
...
# 052046.python.shellcon.line964.comment IShellLinkDataList data block signatures
...
# 052047.python.shellcon.line973.comment IURL_SETURL_FLAGS enum, used with PyIUniformResourceLocator.SetURL
IURL_SETURL_FL_GUESS_PROTOCOL = 1
IURL_SETURL_FL_USE_DEFAULT_PROTOCOL = 2

# 052048.python.shellcon.line977.comment IURL_INVOKECOMMAND_FLAGS enum, used with PyIUniformResourceLocator.InvokeCommand
IURL_INVOKECOMMAND_FL_ALLOW_UI = 1
IURL_INVOKECOMMAND_FL_USE_DEFAULT_VERB = 2
IURL_INVOKECOMMAND_FL_DDEWAIT = 4

# 052049.python.shellcon.line982.comment # constants used with IActiveDesktop
# 052050.python.shellcon.line983.comment COMPONENT.ComponentType
COMP_TYPE_HTMLDOC = 0
COMP_TYPE_PICTURE = 1
COMP_TYPE_WEBSITE = 2
COMP_TYPE_CONTROL = 3
COMP_TYPE_CFHTML = 4
COMP_TYPE_MAX = 4
# 052051.python.shellcon.line990.comment COMPONENT.CurItemState
IS_NORMAL = 1
IS_FULLSCREEN = 2
IS_SPLIT = 4
...
# 052052.python.shellcon.line996.comment IActiveDesktop.ApplyChanges Flags
AD_APPLY_SAVE = 1
AD_APPLY_HTMLGEN = 2
AD_APPLY_REFRESH = 4
...
# 052053.python.shellcon.line1004.comment Wallpaper styles used with GetWallpaper and SetWallpaper
WPSTYLE_CENTER = 0
WPSTYLE_TILE = 1
WPSTYLE_STRETCH = 2
WPSTYLE_MAX = 3
# 052054.python.shellcon.line1009.comment ModifyDesktopItem flags
...
# 052055.python.shellcon.line1067.comment From EmptyVC.h
...
# 052056.python.shellcon.line1077.comment ShObjIdl.h IExplorer* related
EBO_NONE = 0
...
# 052076.python.shellcon.line1179.comment Names of the methods of many shell interfaces; used by implementation of
# 052077.python.shellcon.line1180.comment the interfaces.
...
# 052079.python.shellcon.line1252.comment # enum GETPROPERTYSTOREFLAGS, used with IShellItem2 methods
GPS_DEFAULT = 0
...
# 052080.python.shellcon.line1263.comment # Bind context parameter names, used with IBindCtx::RegisterObjectParam
...
# 052081.python.shellcon.line1271.comment # STR_ENUM_ITEMS_FLAGS
...
# 052082.python.shellcon.line1301.comment # STR_PROPERTYBAG_PARAM
STR_SKIP_BINDING_CLSID = "Skip Binding CLSID"
STR_TRACK_CLSID = "Track the CLSID"

# 052083.python.shellcon.line1305.comment # KF_REDIRECTION_CAPABILITIES enum
...
# 052084.python.shellcon.line1313.comment # KF_REDIRECT_FLAGS enum
...
# 052085.python.shellcon.line1326.comment # KF_CATEGORY enum
KF_CATEGORY_VIRTUAL = 0x00000001
KF_CATEGORY_FIXED = 0x00000002
KF_CATEGORY_COMMON = 0x00000003
KF_CATEGORY_PERUSER = 0x00000004

# 052086.python.shellcon.line1332.comment # FFFP_MODE enum
FFFP_EXACTMATCH = 0
FFFP_NEARESTPARENTMATCH = 1

# 052087.python.shellcon.line1336.comment # APPDOCLISTTYPE, used with IApplicationDocumentLists.GetList
ADLT_RECENT = 0
ADLT_FREQUENT = 1

# 052088.python.shellcon.line1340.comment # KNOWNDESTCATEGORY used with ICustomDestinationList.AppendKnownCategory
KDC_FREQUENT = 1
KDC_RECENT = 2

# 052089.python.shellcon.line1344.comment # LIBRARYFOLDERFILTER used with IShellLibrary.GetFolders
LFF_FORCEFILESYSTEM = 1
LFF_STORAGEITEMS = 2
LFF_ALLITEMS = 3

# 052090.python.shellcon.line1349.comment # DEFAULTSAVEFOLDERTYPE used with IShellLibrary.Get/SetDefaultSaveFolder
DSFT_DETECT = 1
DSFT_PRIVATE = 2
DSFT_PUBLIC = 3

# 052091.python.shellcon.line1354.comment # LIBRARYOPTIONFLAGS used with IShellLibrary.Get/SetOptions
LOF_DEFAULT = 0
LOF_PINNEDTONAVPANE = 1
LOF_MASK_ALL = 1

# 052092.python.shellcon.line1359.comment # LIBRARYSAVEFLAGS Used with PyIShellLibrary.Save
LSF_FAILIFTHERE = 0
LSF_OVERRIDEEXISTING = 1
LSF_MAKEUNIQUENAME = 2

# 052093.python.shellcon.line1364.comment # TRANSFER_SOURCE_FLAGS, used with IFileOperationProgressSink
TSF_NORMAL = 0
TSF_FAIL_EXIST = 0
...
# 052094.python.shellcon.line1380.comment # TRANSFER_ADVISE_STATE, used with ITransferAdviseSink
TS_NONE = 0
TS_PERFORMING = 1
TS_PREPARING = 2
TS_INDETERMINATE = 4

# 052095.python.shellcon.line1386.comment # Success HRESULTs returned by ITransfer* interface operations
...
# 052096.python.shellcon.line1399.comment # Error HRESULTS
