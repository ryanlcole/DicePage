...
/* Mouse-accessible slider navigation. Chooses the rail's active axis and
   advances by most of one visible page while retaining context. */
window.ristWorld.scrollRail=(selector,direction)=>{
