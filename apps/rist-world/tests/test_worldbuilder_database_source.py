...
def test_worldbuilder_publishes_shared_source_to_database_bridge():
    ...
    assert 'worldbuilder-source-host.js?v=20260919-home-return-2' in host
...
def test_regiondefiner_viewer_never_presents_the_map_as_a_second_locked_source():
    ...
    assert "./prototype.js?v=20260919-home-return-2" in index
    assert "renderer=20260919-home-return-2" in workspace
    assert "./region-definer-host.js?v=20260919-home-return-2" in workspace
