...
def main() -> None:
    ...
    require(authenticated, 'href="/Game/terms.html"', "terms gate must expose the full Terms of Service before acceptance")
    require(authenticated, 'href="/Game/privacy.html"', "terms gate must expose the full Privacy Policy before acceptance")
    require(authenticated, "I have reviewed and agree to the Terms of Service and Privacy Policy.", "terms gate must name the policies being accepted")
    require(authenticated, 'disabled="@(!_termsChecked || _savingTerms)"', "agreement submission must stay disabled until the user checks consent")
