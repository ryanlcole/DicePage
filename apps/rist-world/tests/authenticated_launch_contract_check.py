...
def main() -> None:
    ...
    require(authenticated, 'disabled="@(!_policiesRead)"', "agreement checkbox must remain locked until policy end")
    ...
    require(authenticated, "Scroll to the end of both policies before agreeing.", "server-side consent handler must enforce policy scroll completion")
