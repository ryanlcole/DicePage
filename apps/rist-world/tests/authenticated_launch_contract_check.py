...
def main() -> None:
    ...
    require(authenticated, "ristParallax.activateForSession", "Press Start must make parallax active for the launch")
    ...
    forbid(shell, "ToggleParallaxAsync", "landing/start menu must not expose a second Parallax toggle")
    forbid(shell, "PARALLAX @", "landing/start menu must not render a Parallax toggle")
