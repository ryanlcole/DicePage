...
public partial class WorldMap:IDisposable
{
 ...
 void Pinch(){var d=G.Distance();if(G.LastDistance>0){G.Zoom=Math.Clamp(G.Zoom*(d/G.LastDistance),.5,5);G.Moved=true;}G.LastDistance=d;}
