@echo off
REM ================================================================
REM SHAELVIENOS UNIVERSAL TERMINAL [SAFE VERSION]
REM Fixes parenthesis path bug + keeps auto build + multi-shell
REM ================================================================

setlocal EnableExtensions EnableDelayedExpansion
cd /d "%~dp0portable" 2>nul

title ShaelvienOS Terminal [Auto Safe]
color 0A
...
REM --- Auto-bootstrap configuration ---
set "AUTO_LAUNCH_VSDEV=1"
set "AUTO_LAUNCH_CMD=1"
set "AUTO_BUILD_PROJECT=1"

if defined AUTO_BUILD_PROJECT (
    echo Building ShaelvienOS nucleus in background...
...
REM --- Auto-launch preferred terminals ---
if defined AUTO_LAUNCH_VSDEV (
...
if defined AUTO_LAUNCH_CMD (
    if defined found_cmd (
        echo Launching standard Command Prompt...
...
if defined found_wsl (
    echo Launching WSL environment...
